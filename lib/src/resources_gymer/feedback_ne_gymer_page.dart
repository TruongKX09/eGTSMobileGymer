...
import '../api/feed_back_ne_api.dart';

class FeedbackNEScreen extends StatefulWidget {
  // final String? ptId;
  // final String? neId;
  ...
  @override
  State<FeedbackNEScreen> createState() => _FeedbackScreenState();
}

class _FeedbackScreenState extends State<FeedbackNEScreen> {
  int _rating = 0;
          ...
          children: [
            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  FeedBackNEGymerAPI().feedBackNEgymer(
